...
package org.imaginativeworld.whynotcompose.common.compose.compositions.placeholder
...
public fun Modifier.placeholder(
    ...
    Modifier.placeholder(
        ...
        color = PlaceholderDefaults.color(
            backgroundColor = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.15f)
        ),
